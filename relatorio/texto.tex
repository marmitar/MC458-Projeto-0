...
\section{Complexidade}
    ...
    Podemos ver pelo algoritmo que a etapa de divisão, em uma estrutura de árvore, segue trivialmente, com tempo constante $t_1$. A etapa de combinação também tem tempo constante $t_2$, fazendo apenas operações lógicas e aritmética independentes da entrada. A única etapa com tempo dependente da entrada, neste algoritmo, é a conquista, implementada recursivamente.
