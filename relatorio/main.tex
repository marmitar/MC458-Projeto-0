...
\title{\vspace{-2.5cm}\Large Projeto de Algoritmo com Implementação nº 0 \\ \normalsize MC458 - 2s2020 - Tiago de Paula Alves - 187679}
...
\setlist[casos]{wide,labelwidth={\parindent},listparindent={\parindent},parsep={\parskip},topsep={\parskip},label=\textbf{Caso \arabic*}:}

\newlist{ncasos}{description}{2}
\setlist[ncasos]{wide,listparindent={\parindent},parsep={\parskip},topsep={\parskip}}
